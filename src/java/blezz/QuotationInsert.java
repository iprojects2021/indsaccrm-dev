 ...
 * @author Sachin
 */
public class QuotationInsert {

    public static String setQuotationInsert(String useradminid, String usercid_id, String contact, String owner) {
        try {
            ...
            rs3 = st.executeQuery("select  *   FROM mastertable where useradminid='" + useradminid + "' ");
            while (rs3.next()) {
                def[1] = "0";
            ...
            rs3 = st.executeQuery("select  count(id)   FROM quotation where c_='1' and useradminid='" + useradminid + "' ");
            while (rs3.next()) {
            ...
            st.addBatch("insert into quotation values('" + i + "','" + sqlTime + "','0','" + owner + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','0','','" + def[2] + "','','" + def[3] + "','','" + def[4] + "','','" + def[5] + "','" + def[6] + "','','" + def[7] + "','','0','','','','','" + contact + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','0'," + "'" + useradminid + "'," + "'" + usercid_id + "'," + "'" + contact + "'," + "'" + businessinvoiceno + "')");
            int quotationid = i;
            st.executeBatch();
            System.out.println("four");
            rs3 = st.executeQuery("select  id   FROM quotationseller ORDER BY id DESC LIMIT 1 ");
            ...
            st.addBatch("insert into quotationseller values('" + i + "','" + sqlTime + "','" + useradminid + "','" + usercid_id + "','" + quotationid + "','','','','','','','" + company + "','" + name + "','','" + gst + "','" + website + "','" + mobile + "','" + alterphone + "','" + email + "','" + add1 + "','" + add2 + "','" + add3 + "','" + city + "','" + pincode + "','" + state + "','" + country + "','','','','','" + heading + "','" + line1 + "','" + line2 + "','" + line3 + "','" + line4 + "','','" + note + "','','"+bank1+"','"+bank2+"','"+bank3+"','"+bank4+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','')");
