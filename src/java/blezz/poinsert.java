 ...
 * @author Sachin
 */
public class poinsert {

    public static String setPOInsert(String useradminid, String usercid_id, String contact, String owner) {
        try {
            ...
            rs3 = st.executeQuery("select  count(id)   FROM purchaseorder where c_='1' and useradminid='" + useradminid + "' ");
            while (rs3.next()) {
            ...
            st.addBatch("insert into purchaseorder values('" + i + "','" + sqlTime + "','0','" + owner + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','0','','" + def[2] + "','','" + def[3] + "','','" + def[4] + "','','" + def[5] + "','" + def[6] + "','','" + def[7] + "','','0','','','','','" + contact + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','0'," + "'" + useradminid + "'," + "'" + usercid_id + "'," + "'" + contact + "'," + "'" + businessinvoiceno + "')");
            int poid = i;
            st.executeBatch();
            System.out.println("four");
            rs3 = st.executeQuery("select  id   FROM purchaseorderseller ORDER BY id DESC LIMIT 1 ");
            ...
            st.addBatch("insert into purchaseorderseller values('" + i + "','" + sqlTime + "','" + useradminid + "','" + usercid_id + "','" + poid + "','','','','','','','" + company + "','" + name + "','','" + gst + "','" + website + "','" + mobile + "','" + alterphone + "','" + email + "','" + add1 + "','" + add2 + "','" + add3 + "','" + city + "','" + pincode + "','" + state + "','" + country + "','','','','','" + heading + "','" + line1 + "','" + line2 + "','" + line3 + "','" + line4 + "','','" + note + "','','" +bank1+"','" +bank2+"','" +bank3+"','" +bank4+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','')");
