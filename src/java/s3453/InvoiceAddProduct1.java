 ...
 * @author Sachin
 */
@WebServlet(name = "InvoiceAddProduct1", urlPatterns = {"/InvoiceAddProduct1"})
public class InvoiceAddProduct1 extends HttpServlet {
          ...
          {data=rs3.getString(1);
           ...
           ++ii; 
            // st.addBatch("insert into product values('"+ii+"','"+sqlTime+"','','"+owner+"','"+description[1]+"','"+description[2]+"','"+description[4]+"','Active','','"+description[3]+"','"+qty+"','','','','','','','','','','','','','Add','"+incid+"','"+newcontactdbinsert+"','"+description[0]+"','','','','','','')");
              st.addBatch("insert into invoiceproductlog values('"+ii+"','"+sqlTime+"','','"+owner+"','"+pname+"','"+pcode+"','','Active','','"+rate+"','"+qty+"','','','','','','','','','','','','','remove','"+incid+"','','','','','','"+usercid_adminid+"','"+usercid_id+"','"+contact+"')");
...
Statement st=c.createStatement();
  ...
  st.addBatch("update invoice set  "+cal8+"='"+newcontactdbinsert+"',"+ac+"='1',"+ae+"='"+invoicedate+"',"+af+"='"+reversecharge+"',"+ag+"='"+state1+"',"+ah+"='"+statecode1+"',"+ai+"='"+transporter+"',"+aj+"='"+vehicleno+"',"+ak+"='"+supplydate+"',"+all+"='"+supplyplace+"',"+am+"='"+bname+"',"+an+"='"+baddress1+"',"+ao+"='"+baddress2+"',"+app+"='"+baddress3+"',"+aq+"='"+bcontact1+"',"+ar+"='"+bcontact2+"',"+at+"='"+bdistt+"',"+au+"='"+bstate+"',"+aw+"='"+bgstin+"',"+ay+"='"+sname+"',"+az+"='"+saddress1+"',"+ba+"='"+saddress2+"',"
      ...
      response.sendRedirect("invoice.jsp?incid="+incid);
            }
   rs3.close();
      st.close();
      c.close();     }
