 ...
 * @author Sachin
 */
public class QuotationAddProduct extends HttpServlet {
...
Statement st=c.createStatement();
    ...
    while(rs3.next())
          ...
          {data=rs3.getString(1);
           ...
           ++ii; 
        st.addBatch("insert into quotationproductlog values('"+ii+"','"+sqlTime+"','','"+owner+"','"+description[1]+"','"+hsncode+"','','Active','','"+rate+"','"+qty+"','','','','','','','','','','','','','remove','"+incid+"','','','','','','"+usercid_adminid+"','"+usercid_id+"','"+contact+"')");
...
Statement st=c.createStatement();
  ...
  st.addBatch("update quotation set  "+cal8+"='"+newcontactdbinsert+"',"+ac+"='1',"+ae+"='"+invoicedate+"',"+af+"='"+reversecharge+"',"+ag+"='"+state1+"',"+ah+"='"+statecode1+"',"+ai+"='"+transporter+"',"+aj+"='"+vehicleno+"',"+ak+"='"+supplydate+"',"+all+"='"+supplyplace+"',"+am+"='"+bname+"',"+an+"='"+baddress1+"',"+ao+"='"+baddress2+"',"+app+"='"+baddress3+"',"+aq+"='"+bcontact1+"',"+ar+"='"+bcontact2+"',"+at+"='"+bdistt+"',"+au+"='"+bstate+"',"+aw+"='"+bgstin+"',"+ay+"='"+sname+"',"+az+"='"+saddress1+"',"+ba+"='"+saddress2+"',"
      ...
      response.sendRedirect("quotation.jsp?incid="+incid);
            }
        }
        catch(Exception e)
        {
