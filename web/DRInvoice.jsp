    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            <% HttpSession session1 = request.getSession(); // reuse existing
                  ...
                  requestcid=Poul.escapeHtml(request.getParameter("contact"));
                      if (session != null) {
       		 ...
       		 Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" Entering DRInvoice.jsp----------Customer Dashboard---useradmindid="+usercid_adminid+",usercid="+usercid_id);
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <div class="row">
                        <div class="col-xs-12">
                            <form action="ExcelTableInvoice.jsp" method="post">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="prodId" name="customerid" type="hidden" value=<%=requestcid%>
                                                </div>
                                                <!-- /.input group -->
                                            </div>
                                        </div>
...
<% Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+Poul.getPublicIP()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Leaving DRInvoice.jsp------");
