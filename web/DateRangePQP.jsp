    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            <% HttpSession session1 = request.getSession(); // reuse existing
                      ...
                      System.out.println(invoicetype+"ch0");
       		 ...
       		 Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" Entering DateRangePQP.jsp----------Customer Dashboard---useradmindid="+usercid_adminid+",usercid="+usercid_id);
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <div class="row">
                        <div class="col-xs-12">
                            <form action="ExcelTablePQP.jsp" method="post">
                                    <div class="row">
                                        <div class="col-md-6">
...
<% Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+Poul.getPublicIP()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" -----Leaving---DateRangePQP.jsp--------");
