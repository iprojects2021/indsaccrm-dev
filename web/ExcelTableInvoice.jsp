        ...
        <div class="wrapper">
            <% 
                ...
                if (session != null) {
                 ...
                 Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" Entering ExcelTableInvoice.jsp----------Customer Dashboard---useradmindid="+usercid_adminid+",usercid="+usercid_id);
            ...
            <div class="content-wrapper">
                ...
                %>
                <form action="exceldownloadtin.jsp" method="post">
                    <!-- Main content -->
...
<% Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+Poul.getPublicIP()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" -------Leaving------ExcelTableInvoice.jsp--------");
