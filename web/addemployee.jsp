...
<head> <link rel="shortcut icon" href="dist/img/u.png" type="image/x-icon" /> 
  ...
  <title>Add Employee | INDSAC CRM</title>
...
Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+Poul.getPublicIP()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Entering addemployee.jsp----------");
%>
       ...
       EmergencyEmail.send(e,errormsg); 
           ...
           // response.sendRedirect("newleads.jsp");
            if("success".equals(msg)){
                Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+Poul.getPublicIP()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --addemployee.jsp--- Redirecting To------employeedetails.jsp------");
...
<jsp:include page="dist/include/footer.jsp" />
 <% Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+Poul.getPublicIP()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" ----Leaving----addemployee.jsp--------");
...
<script>
    ...
    $('#show-alert').modal('show')
     ...
     return false;
        ...
        if(document.getElementById("cn").value.length>45){
                         document.getElementById("alert-message").innerHTML = "Company Name: Only 45 Characters allowed";
    $('#show-alert').modal('show')
    ...
    $('#show-alert').modal('show')
      ...
      if(document.getElementById("bwtc").value!=""){
           ...
           if(!document.getElementById("bwtc").value.match(/^[0-9 a-z.A-Z]+$/)){
                     document.getElementById("alert-message").innerHTML = "Best Way to Contact: Only alphanumeric allowed";
    $('#show-alert').modal('show')
