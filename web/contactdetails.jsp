...
<head>     <link rel="shortcut icon" href="dist/img/u.png" type="image/x-icon" /> 
  ...
  <title>Customer Details | INDSAC CRM</title>
...
Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+Poul.getPublicIP()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Entering contactdetails.jsp----------Customer Dashboard---");
...
<%
       ...
       if(cid!=null){ cid=Nd.Decrypt(cid);}
         ...
         if(esfhrttrfhardersg!=null ){ cid=Nd.Decrypt(esfhrttrfhardersg);}
     ...
     if(type!=null){ type=Nd.Decrypt(type);}
        ...
        if("null"!=cid && "contact".equals(type)||cid!=null&& "contact".equals(type)){requestcid=cid;
        
        }
       
        Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" ,contact_id="+requestcid+"  --Entering contactdetails.jsp ---");
        if(requestcid==null || requestcid==""){response.sendRedirect("contact.jsp");}
     ...
     + "LINE=116 \n select * from contact where id="+requestcid+" ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg); 
       ...
       //System.out.println(al.size());
                        String invoiceformat=menu.InvoiceMenu.getInvoiceFormat(usercid_adminid);
                        String defaultcity=menu.AdminDefaultValues.getDefaultCity(usercid_adminid, usercid_id);
       
                        if(defaultcity==null || defaultcity=="InActive"|| defaultcity==""){defaultcity="no";}
...
%> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
	 ...
	 <div class="col-md-12">
		 ...
		 <%if(a1[8]!=null&&!a1[8].equals("")&&!a1[8].equals("null")){%>  <h5 align="left">Department&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>&nbsp;&nbsp;<% out.print(a1[8]); %>  </h5><%}%>
              ...
              <%if(a1[13]!=null&&!a1[13].equals("")&&!a1[13].equals("null")){ %><h5 align="left">Status&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>&nbsp;&nbsp;<span class="label label-<%=Contact.statusLeadColor(a1[13]) %>"><% out.print(a1[13]);%></span></h5> <% } %>
		 <h5 align="left">Change Status <strong>:</strong>
                 <form action="leadstatuschange" method="post">
                     ...
                     </select><input type="hidden" name="val" id="convert" value="<%=Nd.Encrypt(requestcid) %>">
                     <input type="hidden" name="change" id="convert" value="contactstatuschange">
    ...
    <%if(a1[30]!=null&&!a1[30].equals("")&&!a1[30].equals("null")){%>  <span class="description-text">  <%=a1[30]%> </span><br><% } %>
     <%if(a1[31]!=null&&!a1[31].equals("")&&!a1[31].equals("null")){%>  <span class="description-text">  <%=a1[31]%> </span><br><% } %>
      ...
      <%if(a1[33]!=null&&!a1[33].equals("")&&!a1[33].equals("null")){%>  <span class="description-text"> <%=a1[33]%> 
    <%if(a1[34]!=null&&!a1[34].equals("")&&!a1[34].equals("null")){%>  <%=a1[34]%><% } %>  </span><br><% } %>
       
      <%if(a1[35]!=null&&!a1[35].equals("")&&!a1[35].equals("null")){%>  <span class="description-text"> <%=a1[35]%>
      <%if(a1[36]!=null&&!a1[36].equals("")&&!a1[36].equals("null")){%><%=a1[36]%><% } %></span><br><% } %>
	...
	<div class="row"><div class="col-sm-3">
                <%  String action="invoice"+invoiceformat+".jsp?2a2e2a74797065=2a2e2a6e6577&2a2e2a636f6e74616374="+Nd.Encrypt(requestcid);
      if("no".equals(defaultcity)){action="invoicesetting.jsp";}
               
                %>
                <form action="<%=action%>" method="post">   <button type="submit" class="btn btn-block btn-primary" ><i class="fa fa-fw fa-plus"></i>Create Invoice</button>
                ...
                <input type="hidden" name="newaddress1" value="<%=a1[30]+" "+a1[31] %>">
                <input type="hidden" name="newaddress2" value="<%=a1[32]+" "+a1[33] %>">
                <input type="hidden" name="newaddress3" value="<%=a1[34]+" "+a1[35]+" "+a1[36] %>">
	...
	<div class="col-sm-3">
            <%   action="purchaseorder.jsp?type=new&contact="+requestcid;
      if("no".equals(defaultcity)){action="invoicesetting.jsp";}
               
                %>
          <form action="<%=action%>" method="post">   <button type="submit" class="btn btn-block btn-primary" ><i class="fa fa-fw fa-plus-circle"></i>Create Purchase Order</button>
                <% session.setAttribute("sessioncontact",requestcid); %>
                <% session.setAttribute("sessiontype","contact"); %>
                <input type="hidden" name="newname" value="<%=a1[5] %>">
                ...
                <div class="col-sm-3">
                    <%   action="proforma.jsp?type=new&contact="+requestcid;
      if("no".equals(defaultcity)){action="invoicesetting.jsp";}
                
                %>
          <form action="<%=action%>" method="post">   <button type="submit" class="btn btn-block btn-primary" ><i class="fa fa-fw fa-plus-square"></i>Create Proforma Invoice</button>
                <% session.setAttribute("sessioncontact",requestcid); %>
                <% session.setAttribute("sessiontype","contact"); %>
                <input type="hidden" name="newname" value="<%=a1[5] %>">
                <input type="hidden" name="newaddress1" value="<%=a1[31] %>">
                ...
                <input type="hidden" name="newpopo" value="newpopo">
                       ...
                       <div class="col-sm-3">
                              <%   action="quotation.jsp?type=new&contact="+requestcid;
      if("no".equals(defaultcity)){action="invoicesetting.jsp";}
                
                %>
          <form action="<%=action%>" method="post">   <button type="submit" class="btn btn-block btn-primary" ><i class="fa fa-fw fa-plus-square-o"></i>Create Quotation</button>
                <% session.setAttribute("sessioncontact",requestcid); %>
                <% session.setAttribute("sessiontype","contact"); %>
                <input type="hidden" name="newname" value="<%=a1[5] %>">
                <input type="hidden" name="newaddress1" value="<%=a1[31] %>">
                ...
                <br><div class="row">
	<div class="col-sm-3">
            <a href="contactedit.jsp?2a2e2a636964=<%=Nd.Encrypt(requestcid) %>">    <button type="button" class="btn btn-block btn-primary"><i class="fa fa-fw fa-edit"></i>Edit Contact Details</button></a>
	</div>
        
        <div class="col-sm-3">
            <a href="task.jsp?2a2e2a636964=<%=Nd.Encrypt(requestcid) %>&2a2e2a74797065=2a2e2a636f6e74616374">    <button type="button" class="btn btn-block btn-primary"><i class="fa fa-fw fa-edit"></i>Create Task</button></a>
	</div>
        <div class="col-sm-3">
            <a href="servicerequest.jsp?2a2e2a636964=<%=Nd.Encrypt(requestcid) %>&2a2e2a74797065=2a2e2a636f6e74616374" >   <button type="button" class="btn btn-block btn-primary"><i class="fa fa-fw fa-edit"></i>Create Service Request</button></a>
	</div>
         <div class="col-sm-3">
            <a href="ComposeMail.jsp?cid=<%=requestcid %>&type=contact" >   <button type="button" class="btn btn-block btn-primary"><i class="fa fa-fw fa-edit"></i>Send Mail</button></a>
	</div>
	</div>
            ...
            <form class="form-horizontal" action="irsubmit.jsp" method="get">
			  ...
			  <div class="form-group">
                ...
                <select id="status" name="status1" class="form-control">
                 ...
                 <input type="hidden" name="2a2e2a636964" value="<%=Nd.Encrypt(requestcid) %>"> 
                   <input type="hidden" name="2a2e2a74797065" value="2a2e2a636f6e74616374">
                  </div>
          ...
          <div class="box box-info">
            ...
            <!-- /.box-body -->
			 <div class="box-footer clearfix">
			  ...
			  <a href="contactedit.jsp?2a2e2a636964=<%=Nd.Encrypt(requestcid) %>"  class="btn btn-sm btn-info btn-flat pull-right"> Edit</a>
	...
	<div class="row">
	 <div class="col-xs-12">
          ...
          <div class="box box-warning">
            ...
            <!-- /.box-body -->
             <div class="box-footer clearfix">
                 <a href="task.jsp?2a2e2a636964=<%=Nd.Encrypt(requestcid) %>&2a2e2a74797065=2a2e2a636f6e74616374" class="btn btn-sm btn-info btn-flat pull-left">Create Task</a>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /.box -->
...
<%
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <% int m1=0; for(m1=n1;m1>0;m1--) {  %>
                  <tr>
                      <td><a  href="iredit.jsp?2a2e2a746964=<%=Nd.Encrypt(taskdata1[m1][1]) %>&2a2e2a636964=<%=Nd.Encrypt(taskdata1[m1][13]) %>&2a2e2a74797065=2a2e2a636f6e74616374"><% out.print(taskdata1[m1][2]); %></a></td>
  ...
  <%
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <table id="example5" class="table table-bordered table-striped">
                ...
                <%   m=1; for(m=1;m<=n;m++) {  %>
                  <tr>
                      <td><a href="servicerequestedit.jsp?2a2e2a636964=<%=Nd.Encrypt(requestdata[m][11]) %>&2a2e2a746964=<%=Nd.Encrypt(requestdata[m][1]) %>&2a2e2a74797065=2a2e2a636f6e74616374"><% out.print("SR"+requestdata[m][1]); %></a></td>
            ...
            <div class="box-body">
              ...
              <table id="example4" class="table table-bordered table-striped">
               ...
               <tbody>
                  ...
                  <tr>
                      <td><a href="invoice<%=invoiceformat%>.jsp?2a2e2a696e636964=<%=Nd.Encrypt(leaddata[m][1])%>&2a2e2a74797065=2a2e2a637573746f6d6572"><% out.print(leaddata[m][254]); %></a></td>
                    <td><% out.print(leaddata[m][2].substring(0,11)); %></td>
                      <td><% out.print(leaddata[m][13]); %></td>
                        <td><% out.print("<i class='fa fa-fw fa-rupee'></i>"+leaddata[m][54]); %></td>
                           <td><span class="label label-<%=menu.InvoiceMenu.statusInvoicePaidColor(leaddata[m][63]) %>"><% if(leaddata[m][63].equals("0")||leaddata[m][63].equals("0.0")){out.println("Paid");}else{out.println("Unpaid");}%></span></td>
                       <td> <%="<i class='fa fa-fw fa-rupee'></i>"+leaddata[m][63]  %> </td> 
                      <td><% out.print(Db.getEmployeeName(leaddata[m][252])); %></td> 
    ...
    rs.close();
      ...
      con.close();   } catch(Exception e){
                String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n contactdetails.jsp-----\n"
     + "LINE=964 \n select * from purchaseorder where customerid="+requestcid+" ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
      }
	...
	<%
     ...
     rs.close(); 
      ...
      con.close();   } catch(Exception e){ 
       String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n contactdetails.jsp---"
           + "\n LINE=1215 \n select count(*) from leadstatuslog where customerid=="+requestcid+" ";
         Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
       EmergencyEmail.send(e,errormsg);
      }
    ...
    rs.close();
      ...
      con.close();    } 
        ...
        { 
           String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n contactdetails.jsp---"
           + "\n LINE=1242 \n select * from leadstatuslog where customerid="+requestcid+" ";
         Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
       EmergencyEmail.send(e,errormsg);
        }
      %>
...
<jsp:include page="dist/include/footer.jsp" />
  <%  
    Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" ,contact_id="+requestcid+"  --Leaving  contactdetails.jsp ---");
