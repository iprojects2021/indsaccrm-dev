...
Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+Poul.getPublicIP()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Entering contactdetails1.jsp-------------");
%>
...
<%
  ...
  <%
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"> Invoice</h3>
               <a class="btn btn-info pull-right " href="DRInvoice.jsp?customerType=customer&contact=<%=requestcid%>">Download to Excel</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Purchase Order</h3>
               <a class="btn btn-info pull-right " href="DateRangePQP.jsp?invoicetype=purchaseorder&contact=<%=requestcid%>">Download to Excel</a>
           </div>
            <!-- /.box-header -->
            <div class="box-body">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Proforma Invoice</h3>
               <a class="btn btn-info pull-right " href="DateRangePQP.jsp?invoicetype=proforma&contact=<%=requestcid%>">Download to Excel</a>
             </div>
            <!-- /.box-header -->
            <div class="box-body">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Quotation</h3>
               <a class="btn btn-info pull-right " href="DateRangePQP.jsp?invoicetype=quotation&contact=<%=requestcid%>">Download to Excel</a>
               </div>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" ,contact_id="+cid+"  --Leaving  contactdetails1.jsp ---");
    
  %>
  <!-- /.content-wrapper -->
<jsp:include page="dist/include/footer.jsp" />
  <% Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+Poul.getPublicIP()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Leaving contactdetails.jsp------");
