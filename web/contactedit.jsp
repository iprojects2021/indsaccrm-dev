...
<head>
  ...
  <title> Contact Edit | INDSAC CRM</title>
...
Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+Poul.getPublicIP()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Entering contactedit.jsp-----------");
%>
...
<p class="pull-right">Created By:<%=al.get(3) %> </p>
          ...
          <div class="box ">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                  ...
                  <div class="col-sm-10">
                      <textarea class="form-control" rows="7" id="previousnotes" name="previousnotes" readonly placeholder="<%=al.get(36) %>" value="<%=al.get(36) %>"><%=al.get(36) %></textarea>
                    <input type="hidden" name="pagetype" value="truece">
                    <input type="hidden" name="2a2e2a636964" value="<%=Nd.Encrypt(al.get(0)) %>">
                  </div>
                </div>
 ...
 <% Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+Poul.getPublicIP()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Leaving contatedit.jsp------");
