...
<%@page import="blezz.InvoiceInsert1"%>
...
Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+Poul.getPublicIP()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" ---------Entering invoice3a.jsp-------------");
        %>
 ...
 Statement st=c.createStatement();
  ...
  ResultSet rs3;
             rs3 = st.executeQuery("select  count(id)   FROM invoice1 where c_='1' and useradminid='"+usercid_adminid+"' ");
     ...
     while(rs3.next())
           ...
           {SR=rs3.getString(1); }
       rs3 = st.executeQuery("select c_  FROM invoice1 where c_='0' and useradminid='"+usercid_adminid+"' ");
     while(rs3.next())
     ...
     cdata[6]=cdata[6].concat(cdata[7]);
            ...
            if("null".equals(che1)){
          int Checkinvoic=0;
         Checkinvoic=InvoiceInsert1.setInvoiceInsert(usercid_adminid, usercid_id, contact, owner);   }
    ...
    rs3.close();
         ...
         {
            String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n invoice3a.jsp-----\n"
     + "LINE=178 + \n select c_  FROM invoice1 where c_='0' and useradminid="+usercid_adminid+" ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg); 
         }
        ...
        <div class="wrapper">
            <%
               ...
               try{
                ...
                PreparedStatement smt=con.prepareStatement("select * from invoice1 where id=?");
            ...
            rs.close();
                ...
                {
                        String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n invoice3a.jsp-----\n"
     + "LINE=219 + \n select * from invoice1 where id="+invoiceid+" ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg); 
                        }
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <div class="row" id="invoice">
                        ...
                        <form method="get" action="InvoiceAddProduct1">
                            <div class="col-sm-3">
                ...
                <section class="invoice">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="callout callout-danger ">
                                <p>Due Amount: <%="<i class='fa fa-fw fa-rupee'></i>"+a1[54]  %></p></div>
                                <% }%>
                                <% } else
                            ...
                            <div class="callout callout-danger ">
                                <h4>Due Amount :<%="<i class='fa fa-fw fa-rupee'></i>"+a1[63]  %></h4></div>
                                <%   }          
                    ...
                    <div class="row invoice-info">
                        ...
                        <div class="col-sm-4 invoice-col">
                            ...
                            <address><strong>Seller</strong><br>
                        ...
                        <div class="col-sm-6 invoice-col">
                            <div class="box box-info"> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <% if("new".equals(type) ){ %>
                                        <input type="text" class="form-control" id="bname" name="bname" <%if("".equals(newname)||"null".equals(newname) ){ %>placeholder="Name" value="" <% }else {%> placeholder="<%=newname %>" value="<%=newname  %>" <% }%>>

                                        <% }else {  %>

                                        <input type="text" class="form-control" id="bname" name="bname" <%if("".equals(a1[13])||"null".equals(a1[13]) ){ %>placeholder="Name" value="" <% }else {%> placeholder="<%=a1[13] %>" value="<%=a1[13]  %>" <% }%>>
                                ...
                                <br><br>  <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select id="bstate" name="bstate" class="form-control" value="<%=(a1[21]) %>">
                                            <%if("".equals(a1[21])||"null".equals(a1[21]) ){ %> <option value="<%=newstate  %>"><%=newstate %></option> <% }else {%>   <option value="<%=(a1[21]) %>"><%=(a1[21]) %></option> <% }%>                    
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>   <a href="invoice3a.jsp?incid=<%=invoiceid %>&type=proinedit&sn=<%=a1[jj]  %>" >  <i class="fa fa-edit"></i></a>
                         ...
                         rs.close();
                                  ...
                                  {
                                       String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n invoice3a.jsp-----\n"
     + "LINE=912 + \n select count(*) from stock where useradminid="+invoiceid+" ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg); 
                                  }
     ...
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg); 
                        ...
                        pronamevalue=taskdata2[i][2]+" HSN="+taskdata2[i][5] ;   %>
                                        ...
                                        <td>    
                                            <input type="text" class="form-control" id="rate" name="discount_rate"  placeholder="0" value="0" > 
                                        </td>
                                        <td>    
                                            <input type="text" class="form-control" id="rate" name="taxable_value"  placeholder="0" value="0" > 
                                        </td>
                                        <td>    
                                            <input type="text" class="form-control" id="rate" name="cgst"  placeholder="0" value="0" > 
                                        </td>
                                        <td>    
                                            <input type="text" class="form-control" id="rate" name="rate"  placeholder="0" value="0" > 
                                        </td>
                    ...
                    <div class="row">
                        <div class="box-header with-border">
                            <h3 class="box-title">Amount Calculated</h3>
                        </div>
                        <div class="col-xs-6 table-responsive ">
                            <table class="table table-striped">
                                <thead>
                                    ...
                                    <tr>
                                        <td>CGST</td>
                                        <td><input type="text" class="form-control" name="" placeholder="<%=a1[43] %>" value="<%=a1[43] %>"></td>
                                        <td><i class="fa fa-fw fa-rupee"></i><%if("".equals(a1[44])||"null".equals(a1[44]) ){ %>00.00 <% }else {%> <%=a1[44]  %> <% }%></td>

                                    </tr>
                                    <tr>
                                        <td>SGST</td>
                                        <td><input type="text" class="form-control" name="" placeholder="<%=a1[45] %>" value="<%=a1[45] %>"></td>
                                        <td><i class="fa fa-fw fa-rupee"></i><%if("".equals(a1[46])||"null".equals(a1[46]) ){ %>00.00 <% }else {%> <%=a1[46]  %> <% }%></td>

                                    </tr>
                                    <tr>
                                        <td>IGST</td>
                                        <td><input type="text" class="form-control" id="igst" name="igst" placeholder="<%=a1[47] %>" value="<%=a1[47] %>"></td>
                            ...
                            <table class="table table-striped">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td><%if("".equals(a1[51])||"null".equals(a1[51]) ){ %><i class="fa fa-fw fa-rupee"></i>00.00  <input type="hidden" name="totalamount" value="00.00"><% }else {%> <i class="fa fa-fw fa-rupee"></i><%=a1[51]  %>  <input type="hidden" name="totalamount" value="<%=a1[51]  %>"><% }%></td>

                                    </tr>
                                    <tr>
                                        <td>Freight Charges</td>
                                        <td><input type="text" class="form-control" id="discount" name="discount" placeholder="<%=a1[52] %>" value="<%=a1[52] %>"</td>
                                    ...
                                    <tr>
                                        <td>Net Amount</td>
                                        <td><%if("".equals(a1[54])||"null".equals(a1[54]) ){ %><i class="fa fa-fw fa-rupee"></i> 00.00 <input type="hidden" name="netamount" value="00.00"> <% }else {%><i class="fa fa-fw fa-rupee"></i> <%=a1[54]  %> <input type="hidden" name="netamount" value="<%=a1[54]  %>"> <% }%></td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-info">
                                ...
                                <%  System.out.println(a1[41]+"feelll");
                                    j=71;
                        ...
                        <div class="col-xs-4">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <th>Freight Charges
                                      <!--  <input type="text" class="form-control" id="discount" name="discountname" placeholder="<%=a1[61] %>" value="<%=a1[61] %>">  -->
      ...
      EmergencyEmail.send(e,errormsg); 
                    ...
                    rs.close();
                            ...
                            con.close();    }
                                    ...
                                    String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n invoice3a.jsp-----\n"
     + "LINE=1462 + \n sselect * from paymentinfo where invoiceid="+invoiceid+" ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
                                 } 
...
<% Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+Poul.getPublicIP()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Leaving invoice3a.jsp------");
