...
if (session != null) {
 ...
 Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+Poul.getPublicIP()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Entering invoicecopy.jsp----------Compose Mail---");
      ...
      if(incid!=null || incid!=""||incid!="null"){invoiceid=incid; }
        ...
        isn=7*(isn-1)+71; 
           ...
           int cid= Integer.parseInt( contact ); 
...
Statement st=c.createStatement();
 ...
 ResultSet rs3;
   ...
   st.addBatch("insert into invoice values('"+i+"',"
                      + "'"+sqlTime+"',"
                      + "'0'," + "'"+owner+"'," + "''," + "'',"   + "'',"  + "'',"+ "'',"+ "'',"
                       + "'',"+ "''," + "'"+cdata[6]+"',"  + "'"+cdata[30]+"',"+ "'"+cdata[31]+"'," + "'"+cdata[32]+"'," + "'"+cdata[20]+"'," + "'"+cdata[21]+"'," + "''," + "'"+cdata[38]+"',"
                        + "'"+cdata[35]+"'," + "''," + "''," + "''," + "'',"
                       + "''," 
                      + "'',"
                      + "'',"
      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="invoice.jsp?type=new"><i class="fa fa-user-plus"></i> New Invoice</a></li>
          ...
          <br>
            <div class="form-group">
              <div class="col-sm-4">
                ...
                <% String date=(a1[2]).substring(0,10); 
...
<option value="Yes">No</option>
 ...
 <select id="state1" name="state1" class="form-control" value="<%=(a1[7]) %>">
     <%if("".equals(a1[7])||"null".equals(a1[7]) ){ %> <option value="Madhya Pradesh">Madhya Pradesh</option> <% }else {%>   <option value="<%=(a1[7]) %>"><%=(a1[7]) %></option> <% }%>                    
...
<option value="West Bengal">West Bengal</option>
          ...
          <br><br>  <div class="form-group">
              <div class="col-sm-4">
                  <b>State Code</b> </div>
                  <div class="col-sm-8">
                     <input type="text" class="form-control" id="statecode1" name="statecode1" <%if("".equals(a1[8])||"null".equals(a1[8]) ){ %>placeholder="statecode1" <% }else {%> placeholder="<%=a1[8] %>" value="<%=a1[8]  %>" <% }%>>
...
<select id="bstate" name="bstate" class="form-control" value="<%=(a1[21]) %>">
     <%if("".equals(a1[21])||"null".equals(a1[21]) ){ %> <option value="Madhya Pradesh">Madhya Pradesh</option> <% }else {%>   <option value="<%=(a1[21]) %>"><%=(a1[21]) %></option> <% }%>                    
...
<select id="sstate" name="sstate" class="form-control" value="<%=(a1[33]) %>">
     <%if("".equals(a1[33])||"null".equals(a1[33]) ){ %> <option value="Madhya Pradesh">Madhya Pradesh</option> <% }else {%>   <option value="<%=(a1[33]) %>"><%=(a1[33]) %></option> <% }%>                    
...
<% Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+Poul.getPublicIP()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Leaving invoicecopy.jsp------");
