      ...
      EmergencyEmail.send(e,errormsg);
               ...
               try{
                    ...
                    if("0".equals(check) ){
                     ...
                     Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"   Invoice chec="+check);
                    ...
                    if("null".equals(che1)){
                    int Checkinvoic=0;
                     Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"   Calling New invoice row");
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="row" id="invoice">
                        <div class="col-sm-3">
                            <a href="invoice/invoiceprintdef.jsp?2a2e2a696e636964=<%=Nd.Encrypt(invoiceid) %>" target="_blank"> <button type="button" class="btn btn-block btn-info"<%if(cfinal==0 || c1!=1){%>disabled<%}%>><i class="fa fa-fw fa-print"></i>Print</button></a>
                        </div>
                        <div class="col-sm-3"> 
                        ...
                        <form method="post" action="invoicedef.jsp" > 
                             <%if(c1!=0){%>
                            <div class="col-sm-4">
                ...
                <form method="get" action="InvoiceAddProductdef">
                <!-- Main content -->
                      ...
                      if("0".equals(invoicelogofile) || "".equals(invoicelogofile)) {     %>
                        ...
                        <div class="col-sm-3">
                            ...
                            <% } 
                                  ...
                                  if("0.0".equals(a1[63])||"0".equals(a1[63]) ){
                             %> 
     ...
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select   class="form-control" id="description" name="description1" required >
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <th> Notes</th>
                                                <td>  <input type="text" class="form-control" id="notes" name="notes" placeholder="Add Deposit Notes" autocomplete="off" >
</td>
     ...
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);  
                        ...
                        int ij = Integer.parseInt(count123 );  
                         String leaddata[][]=new String[ij+1][256];
                         int k=1; i=1; 
                        try{
                                    ...
                                    <table id="example7" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><i class="fa fa-fw fa-<%=currency%>"></i><% out.print(leaddata[m][8]); %></td>

                                                <td><% out.print(leaddata[m][10]); %></td>
                                                <td><i class="fa fa-fw fa-<%=currency%>"></i><% out.print(leaddata[m][12]); %></td>
                                                <td>
                                                    <script>var createdby<%=m%>="<%=Db.getEmployeeName(leaddata[m][252]) %>";var receiptno<%=m%>="<%=leaddata[m][1] %>",depositrecordname<%=m%>="<%=leaddata[m][7] %>",ramnt<%=m%>="<%=leaddata[m][8] %>",depositrecordmop<%=m%>="<%=leaddata[m][10] %>";
 var depositrecordpr<%=m%>="<%=leaddata[m][11] %>",depositrecordnotes<%=m%>="<%=leaddata[m][14] %>",depositrecorddueamnt<%=m%>="<%=leaddata[m][12] %>";
 </script>
                                                    <button class="btn btn-primary" onclick="viewDepositRecord(createdby<%=m%>,receiptno<%=m%>,depositrecordname<%=m%>,ramnt<%=m%>,depositrecorddueamnt<%=m%>,depositrecordmop<%=m%>,depositrecordpr<%=m%>,depositrecordnotes<%=m%>)">Details</button>
                                              </td>
                                            </tr>
 <% } %>
  </tbody>
                    ...
                    <!-- /.row -->   
      <div class="modal fade" id="showdeposit">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header bg-primary">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" >Deposit Record</h4>
              </div>
              <div class="modal-body">
                <table>
                                                              <tbody>
                                                                  <tr>
                                                                      <td><strong>Cash Receipt</strong></td><td>:</td>
                                                                      <td id="depositreceiptno" style="align:left;"></td>
                                                                      <td></td>
                                                                      <td><strong>Created By </strong></td><td>:</td>
                                                                      <td id="depositcreatedby">  </td>
                                                                  </tr>
                                                                 
                                                                  <tr>
                                                                      <td><strong>Depositor Name</strong> </td><td>:</td>
                                                                      <td  id="depositrecordname"></td>
                                                                       
                                                                  </tr>
                                                                  <tr>
                                                                      <td><strong>Amount Received</strong> </td><td>:</td>
                                                                      <td id="depositrecordamnt"></td>
                                                                      <td></td>
                                                                      <td><strong>Due Amount </strong></td><td>:</td>
                                                                      <td id="depositrecorddueamnt"></td>
                                                                  </tr>
                                                                  <tr>
                                                                      <td><strong>Mode of Payment </strong></td><td>:</td>
                                                                      <td  id="depositrecordmop"></td>
                                                                  </tr>
                                                                  <tr>
                                                                      <td><strong>Payment Reference</strong></td><td>:</td>
                                                                      <td id="depositrecordpr"></td>
                                                                  </tr>
                                                                  <tr>
                                                                      <td><strong>Notes </strong></td><td>:</td>
                                                                      <td id="depositrecordnotes"></td>
                                                                  </tr>
  ...
  if (document.getElementById("description").value= "") {
                        document.getElementById("alert-message").innerHTML = "Please select product";
                        $('#show-alert').modal('show')

                        //alert("Only alphanumeric alowed");
...
function viewDepositRecord(createdby,receiptno,depositrecordname,ramnt,depositrecorddueamnt,depositrecordmop,depositrecordpr,depositrecordnotes)  
{  document.getElementById("depositrecordmop").innerHTML = depositrecordmop;
      document.getElementById("depositrecordpr").innerHTML = depositrecordpr;
      document.getElementById("depositrecordnotes").innerHTML = depositrecordnotes;
     
    document.getElementById("depositcreatedby").innerHTML =createdby;
    document.getElementById("depositreceiptno").innerHTML ="#"+ receiptno;
     document.getElementById("depositrecordname").innerHTML = depositrecordname;
       document.getElementById("depositrecordamnt").innerHTML = '<i class="fa fa-fw fa-<%=currency%>"></i>'+ramnt;
       document.getElementById("depositrecorddueamnt").innerHTML = '<i class="fa fa-fw fa-<%=currency%>"></i>'+depositrecorddueamnt;
      document.getElementById("printdepositrecord").innerHTML = '<a target="_blank" href="invoice/cashreceiptf10.jsp?2a2e2a696e636964=<%=Nd.Encrypt(invoiceid)%>&2a2e2a64726964=<%="'+receiptno+'"%>" class="btn btn-primary">Print</a>';
