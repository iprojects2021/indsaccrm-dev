...
Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+"   --  Entring invoiceeditproduct.jsp---");
    ...
    while(rs3.next())
     ...
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      ...
      response.sendRedirect("invoice.jsp?incid="+incid+"&sn="+imaxxx+"#sn");
                ...
                Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+"   ----------invoiceeditproduct.jsp----------------Redirecting To---------------lead.jsp---------------");
