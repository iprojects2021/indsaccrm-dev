            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="row" id="invoice">
                        ...
                        <form method="post" action="invoicef10.jsp" > 
                             <%if(c1!=0){%>
                            <div class="col-sm-4">
                        ...
                        <div class="col-xs-4">
                            <div class="table-responsive">
                                <table class="table">
                                    <tr>
                                        <th>PF
                                            <input type="text" class="form-control" id="pf" name="pf" placeholder="<%=a1[41] %>" value="<%=a1[41] %>" required="">
                                        </th>
                                        <td><%if("".equals(a1[42])||"null".equals(a1[42]) ){ %>00.00 <% }else {%> <%=a1[42]  %> <% }%></td>
                                    </tr>
                                    <tr>
                                        <th><p>Add: CGST-</p>
                                    <input type="text" class="form-control" id="cgst"name="cgst" placeholder="<%=a1[43] %>" value="<%=a1[43] %>" required="">
                                        </th>
                                        <td><%if("".equals(a1[44])||"null".equals(a1[44]) ){ %>00.00 <% }else {%> <%=a1[44]  %> <% }%></td>
                                    </tr>
                                    <tr>
                                        <th>Add: SGST-
                                            <input type="text" class="form-control" id="sgst" name="sgst" placeholder="<%=a1[45] %>" value="<%=a1[45] %>" required="">
                                        </th>
                                        <td><%if("".equals(a1[46])||"null".equals(a1[46]) ){ %>00.00 <% }else {%> <%=a1[46]  %> <% }%></td>
                                    </tr>
                                    <tr>
                                        <th>Add: IGST-
                                            <input type="text" class="form-control" id="igst" name="igst" placeholder="<%=a1[47] %>" value="<%=a1[47] %>" required="">
                                        </th>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <input type="text" class="form-control" id="discount" name="discount" placeholder="<%=a1[52] %>" value="<%=a1[52] %>" required="">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Net Amount:</th>
