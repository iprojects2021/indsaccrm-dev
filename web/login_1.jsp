...
<%   
    HttpSession session1 = request.getSession(false); // reuse existing
		
			if (session1.getAttribute("ownr") != null) {
				session1.removeAttribute("ownr");
...
<div class="lockscreen-wrapper">
  ...
  <div class="lockscreen-item">
    ...
    <div class="lockscreen-image">
      <img src="IndsacCRM/dist/img/u.png" alt="User Image">
    </div>
    <!-- /.lockscreen-image -->

    <!-- lockscreen credentials (contains the form) -->
    <form class="lockscreen-credentials" action="IndsacCRM/logincheck.jsp" mothod="post">
...
<!-- jQuery 3 -->
<script src="IndsacCRM/bower_components/jquery/dist/jquery.min.js"></script>
<!-- Bootstrap 3.3.7 -->
<script src="IndsacCRM/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
<script>
