...
<html lang="en">
  <head><link rel="shortcut icon" href="../dist/img/u.png" type="image/x-icon" />
      <link rel="canonical" href="https://www.indsaccrm.com/360view.jsp" />
        ...
        <div class="about-inner inner2">
            <div class="container seen-w3">
                <ul class="breadcrumbs-custom-path">
                    ...
                    <li class="active">360 Degree view</li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <div class="content-with-photo4-block">
        <div class="container">
            ...
            <div class="col-xl-6 cwp4-image ">
                <img src="assets/images/360.jpg" alt="product" class="img-responsive ">
            </div>
...
<p class="para">A 360-degree view drives your customer management strategy by providing a more complete picture of 
