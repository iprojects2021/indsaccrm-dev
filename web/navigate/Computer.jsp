...
<html lang="en">
  <head> <link rel="shortcut icon" href="../dist/img/u.png" type="image/x-icon" />
         <link rel="canonical" href="https://indsaccrm.com/navigate/Computer.jsp" />
         <link rel="apple-touch-icon" href="dist/img/u.png"/>
         <link rel="alternate" hreflang="en" href ="https://indsaccrm.com/navigate/Computer.jsp" />
        ...
        <div class="about-inner inner2">
            <div class="container seen-w3">
                <ul class="breadcrumbs-custom-path">
                    ...
                    <li class="active">Computer Industry</li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <div class="content-with-photo4-block">
        <div class="container">
            ...
            <div class="col-xl-6 cwp4-image ">
                <img src="assets/images/comgif.gif" alt="product" class="img-responsive ">
            </div>
                <div class="cwp4-text col-xl-6">
                    <h4>Computer Industry</h4>
                    <p class="para"> Computer Industry has taken over almost every other industry. Computer industry or also known as Information Technology (IT) Industry.
                    </p>
                    <div class="jst-two-coloums mt-4">
                        ...
                        <div class="icon-text mt-lx-3 pt-lx-1">
                            ...
                            <p class="para">The service sector has gone online in almost every sector such as health, education, retail, bank, beauty. There are hundreds of websites and apps for every single service.</p>
                        </div>
                    </div>
                </div>
            </div>
