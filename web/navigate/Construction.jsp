...
<html lang="en">
  <head><link rel="shortcut icon" href="../dist/img/u.png" type="image/x-icon" />
        <link rel="canonical" href="https://indsaccrm.com/navigate/Construction.jsp" />
        <link rel="apple-touch-icon" href="dist/img/u.png"/>
        <link rel="alternate" hreflang="en" href ="https://indsaccrm.com/navigate/Construction.jsp" />
...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
  ...
  <body id="Construction">
      ...
      <%  Log.writeWEBLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" "+request.getProtocol()+", "+Poul.getPublicIP()+""
              + ", "+request.getRemoteHost()+", Entering Construction.jsp");
      %>
    ...
    <div class="content-with-photo4-block">
        <div class="container">
            ...
            <div class="col-xl-6 cwp4-image ">
                <img src="assets/images/consgif.gif" alt="product" class="img-responsive ">
            </div>
...
<section class="w3l-content-with-photo-4">
    <div class="content-with-photo4-block">
        <div class="container">
            <div class="cwp4-two row">
            <div class="col-xl-6 cwp4-image ">
                <img src="assets/images/co1.jpg" alt="product" class="img-responsive ">
            </div>
                <div class="cwp4-text col-xl-6">
        ...
        <div class="container">
            <div class="cwp4-two row">
                ...
                <div class="cwp4-text col-xl-6">
				 ...
				 <div class="col-xl-6 cwp4-image ">
                <img src="assets/images/const1.jpg" alt="product" class="img-responsive ">
            </div>
            </div>
        </div>
    </div>
...
<section class="w3l-content-with-photo-4">
    <div class="content-with-photo4-block">
        <div class="container">
            <div class="cwp4-two row">
            <div class="col-xl-6 cwp4-image ">
                <img src="assets/images/imp1.png" alt="product" class="img-responsive ">
            </div>
                <div class="cwp4-text col-xl-6">
...
<%  Log.writeWEBLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" "+request.getProtocol()+", "+Poul.getPublicIP()+""
              + ", "+request.getRemoteHost()+", Leaving Construction.jsp");
      %>
</body>
