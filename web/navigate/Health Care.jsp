...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
  ...
  <body id="Health Care">
      ...
      <%  Log.writeWEBLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" "+request.getProtocol()+", "+Poul.getPublicIP()+""
              + ", "+request.getRemoteHost()+", Entering Health Care.jsp");
      %>
    ...
    <div class="content-with-photo4-block">
        <div class="container">
            ...
            <div class="col-xl-6 cwp4-image ">
                <img src="assets/images/h1.jpg" alt="product" class="img-responsive ">
            </div>
...
and access medical histories of patients to provide better care.<br>The reporting module of the CRM can be designed to segment the patient population to analyze and then understand them better. </p>
				 ...
				 <div class="col-xl-6 cwp4-image ">
                <img src="assets/images/h3.png" alt="product" class="img-responsive ">
            </div>
            </div>
        </div>
    </div>
    ...
    <div class="content-with-photo4-block">
        <div class="container">
            <div class="cwp4-two row">
            <div class="col-xl-6 cwp4-image ">
                <img src="assets/images/h4.jpg" alt="product" class="img-responsive ">
            </div>
                <div class="cwp4-text col-xl-6">
...
<!-- /move top -->
<%  Log.writeWEBLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" "+request.getProtocol()+", "+Poul.getPublicIP()+""
              + ", "+request.getRemoteHost()+", Leaving Health Care.jsp");
      %>
</body>
