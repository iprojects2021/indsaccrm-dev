...
<html lang="en">
  <head><link rel="shortcut icon" href="../dist/img/u.png" type="image/x-icon" />
        <link rel="canonical" href="https://www.indsaccrm.com/Pharmaceutical.jsp" />
    ...
    <meta name="description" content="The pharmaceutical company is a firm to research, discover, develop, market, and sell drugs. It is an important industry worldwide">
    ...
    <div class="content-with-photo4-block">
        <div class="container">
            ...
            <div class="col-xl-6 cwp4-image ">
                <img src="assets/images/pharma.gif" alt="product" class="img-responsive ">
            </div>
...
<!-- /move top -->
<%  Log.writeWEBLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" "+request.getProtocol()+", "+request.getRemoteAddr()+""
              + ", "+request.getRemoteHost()+", Leaving Pharmaceutical.jsp");
      %>
</body>
