        ...
        <div class="about-inner inner2">
            <div class="container seen-w3">
                <ul class="breadcrumbs-custom-path">
                    ...
                    <li class="active">Stable Growth</li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <div class="content-with-photo4-block">
        <div class="container">
            ...
            <div class="col-xl-6 cwp4-image ">
                <img src="assets/images/sg.gif" alt="product" class="img-responsive ">
            </div>
                <div class="cwp4-text col-xl-6">
                    ...
                    <div class="jst-two-coloums mt-4">
                        <div class="icon-text">
                            ...
                            <p class="para">Building business relationships in an extensive competitive market are not simple. 
...
<p class="para"> Selling a business solution to an existing customer is more than 70%. 
...
<p class="para"> Adopting the right technology frees up your teams from process-heavy tasks and gives them more time to 
    ...
    <div class="content-with-photo4-block">
        <div class="container">
            ...
            <div class="cwp4-two row">
                ...
                <div class="cwp4-text col-xl-6">
                    ...
                    <p class="para"> 1. Improving sales efficiency <br>
	 ...
	 <div class="col-xl-6 cwp4-image ">
                <img src="assets/images/sg1.gif" alt="product" class="img-responsive ">
            </div>
            </div>
            </div>
        </div>
