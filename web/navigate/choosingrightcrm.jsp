...
<html lang="en">
  <head> <link rel="shortcut icon" href="../dist/img/u.png" type="image/x-icon" />
    ...
    <title>Best Customer Relationship Management Software | Choosing Right CRM :: indsaccrm.com</title>
        ...
        <div class="about-inner inner2">
            <div class="container seen-w3">
                <ul class="breadcrumbs-custom-path">
					...
					<li><a href="resources.jsp">Resources<span class="fa fa-angle-right" aria-hidden="true"></span></a></li>
                    <li class="active">Choosing Right CRM</li>
                </ul>
            </div>
        </div>
    </section>
...
<!-- /move top -->
<%  Log.writeWEBLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" "+request.getProtocol()+", "+Poul.getPublicIP()+""
              + ", "+request.getRemoteHost()+", Leaving choosingrightcrm.jsp");
      %>
</body>
