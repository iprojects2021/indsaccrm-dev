...
<html lang="en">
  <head><link rel="shortcut icon" href="../dist/img/u.png" type="image/x-icon" />
        <link rel="canonical" href="https://indsaccrm.com/navigate/panalysis.jsp" />
        <link rel="apple-touch-icon" href="dist/img/u.png"/>
        <link rel="alternate" hreflang="en" href ="https://indsaccrm.com/navigate/panalysis.jsp" />
...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
  ...
  <body id="Contact Management">
      ...
      <%  Log.writeWEBLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" "+request.getProtocol()+", "+Poul.getPublicIP()+""
              + ", "+request.getRemoteHost()+", Entering  panalysis.jsp");
      %>
    ...
    <div class="content-with-photo4-block">
        <div class="container">
            ...
            <div class="col-xl-6 cwp4-image ">
                <img src="assets/images/pa1.jpg" alt="product" class="img-responsive ">
            </div>
	 ...
	 <div class="col-xl-6 cwp4-image ">
                <img src="assets/images/pa3.png" alt="product" class="img-responsive ">
            </div>
            </div>
...
<section class="w3l-content-with-photo-4">
	...
	<div class="col-xl-6 cwp4-image ">
                <img src="assets/images/pa5.jpg" alt="product" class="img-responsive ">
            </div>
            </div>
        </div>
    </div>
...
<section class="w3l-content-with-photo-4">
    <div class="content-with-photo4-block">
        <div class="container">
            <div class="cwp4-two row">
            <div class="col-xl-6 cwp4-image ">
                <img src="assets/images/pa4.jpg" alt="product" class="img-responsive ">
            </div>
                <div class="cwp4-text col-xl-6">
...
<section class="w3l-content-with-photo-4">
	...
	<div class="col-xl-6 cwp4-image ">
                <img src="assets/images/pa6.png" alt="product" class="img-responsive ">
            </div>
            </div>
        </div>
    </div>
...
<!-- /move top -->
<%  Log.writeWEBLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" "+request.getProtocol()+", "+Poul.getPublicIP()+""
              + ", "+request.getRemoteHost()+", Leaving panalysis.jsp");
      %>
</body>
