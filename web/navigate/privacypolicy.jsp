...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
  ...
  <body id="Privacy Policy">
      ...
      <%  Log.writeWEBLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" "+request.getProtocol()+", "+Poul.getPublicIP()+""
              + ", "+request.getRemoteHost()+", Entering privacypolicy.jsp");
      %>
...
<p class="para">If you sign-up for a free trial Account, you are not required to enter your credit card information unless and until you decide to continue with a 
...
<p class="para">Social Media Widgets:<br>
...
<p class="para">If you have any questions about this Privacy Policy, or if you have a disability and need to access this notice in a different format, 
...
<!-- /move top -->
<%  Log.writeWEBLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" "+request.getProtocol()+", "+Poul.getPublicIP()+""
              + ", "+request.getRemoteHost()+", Leaving privacypolicy.jsp");
      %>
</body>
