...
<html lang="en">
  <head><link rel="shortcut icon" href="../dist/img/u.png" type="image/x-icon" />
        <link rel="canonical" href="https://indsaccrm.com/navigate/salesforcasting.jsp" />
        <link rel="apple-touch-icon" href="dist/img/u.png"/>
        <link rel="alternate" hreflang="en" href ="https://indsaccrm.com/navigate/salesforcasting.jsp" />
...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
  ...
  <body id="Contact Management">
      ...
      <%  Log.writeWEBLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" "+request.getProtocol()+", "+Poul.getPublicIP()+""
              + ", "+request.getRemoteHost()+", Entering salesforcasting.jsp");
      %>
            ...
            <div class="container seen-w3">
                <ul class="breadcrumbs-custom-path">
                    ...
                    <li ><a href="services.jsp">Services <span class="fa fa-angle-right" aria-hidden="true"></span></a></li>
					 <li class="active">Sales Forecasting</li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <div class="content-with-photo4-block">
        <div class="container">
            ...
            <div class="col-xl-6 cwp4-image ">
                <img src="assets/images/sfgif.gif" alt="product" class="img-responsive ">
            </div>
...
<section class="w3l-content-with-photo-4">
    <div class="content-with-photo4-block">
        <div class="container">
            ...
            <div class="cwp4-two row">
                ...
                <div class="cwp4-text col-xl-6">
                    ...
                    <p class="para"> 1. Map out Sales Growth<br><br> 
	 ...
	 <div class="col-xl-6 cwp4-image ">
                <img src="assets/images/sf1.jpg" alt="product" class="img-responsive ">
            </div>
            </div>
            </div>
        </div>
            ...
            <div class="features-effect row text-center">
                ...
                <div class="grids-effect-2 col-lg-4 col-md-6 col-sm-6">
                    ...
                    <div class="back-color">
                        ...
                        <p class="para"> Wide range of reporting tools to analyze your sales performance compared to previous periods, track and improve team productivity.</p>
                    </div>
                </div>	
                ...
                <div class="grids-effect-2 col-lg-4 col-md-6 col-sm-6">
                 ...
                 <div class=" grids-effect-2 col-lg-4 col-md-6 col-sm-6">
                    ...
                    <div class="back-color">
                        ...
                        <p class="para">Identify top lead sources and allocate resources toward your most profitable sales activities.</p>
                    </div>
                </div>
                ...
                <div class=" grids-effect-2 col-lg-4 col-md-6 col-sm-6 mt-4 pt-1">
                  ...
                  <div class=" grids-effect-2 col-lg-4 col-md-6 col-sm-6 mt-4 pt-1">
                    ...
                    <div class="back-color">
                        ...
                        <p class="para">When the strength of your sales team fluctuates, your sales numbers will automatically change.
...
<!-- /move top -->
<%  Log.writeWEBLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" "+request.getProtocol()+", "+Poul.getPublicIP()+""
              + ", "+request.getRemoteHost()+", Leavingsalesforcasting.jsp");
      %>
</body>
