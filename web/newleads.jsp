...
Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Entering newleads.jsp----------New Lead---");
%>
    
          
    <%    String pagetype=Poul.escapeHtml(request.getParameter("pagetype"));
      if("newleadsubmit".equals(pagetype)){
...
Statement st=c.createStatement();
           ResultSet rs3;
               rs3 = st.executeQuery("SELECT MAX(Id)FROM contact  ");
    while(rs3.next())
          ...
          {SR=rs3.getString(1);
           ...
           ++i; 
             st.addBatch("insert into contact values('"+i+"','"+sqlTime+"','0','"+ownr+"','"+cn+"','"+cfn+"','"+cln+"','"+department+"','"+designation+"','"+dob+"','','','"+status+"','"+rt+"','"+source+"','','"+vn+"','"+website+"','"+bwtc+"','"+mobile+"','"+alternetmobile+"','"+phone+"','"+email+"','"+oe+"','"+fax+"','"+oai+"','"+oai1+"','"+oai2+"','"+oai3+"','"+address1+"','"+address2+"','"+address3+"','"+city+"','"+pincode+"','"+state+"','"+country+"','"+notes+"','"+gstin+"','"+usercid_adminid+"','"+usercid_id+"','lead','"+sqlTime+"','','','','','','','','')");
    ...
    while(rs3.next())
          ...
          {SR=rs3.getString(1);
           ...
           ++i; 
            st.addBatch("insert into leadstatuslog values('"+i+"','"+sqlTime+"','0','','','New','"+status+"','','"+usercid_adminid+"','"+usercid_id+"','"+customerid+"','','','','','','','','','','','','','','','','','','','','','','')");
      
       
       
       st.executeBatch(); 
        String requestcid=Integer.toString(i);
        session.setAttribute("requestid",customerid);
    ...
    rs3.close();
      ...
      c.close();     }
        catch(Exception e)
        {
                   ...
                   + "\nLINE=149 \n insert into contact values '"+cn+"','"+cfn+"','"+cln+"','"+department+"' ";
       ...
       EmergencyEmail.send(e,errormsg); 
        ...
        response.sendRedirect("leaddetails.jsp");
                ...
                Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+"   --  Entring newleads.jsp------Redirecting To------newleads.jsp-------");
               response.sendRedirect("newleads.jsp");
            }
        }
          ...
          <div class="box ">
            ...
            <!-- form start -->
			 ...
			 <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <input type="text" list="showdatalist" class="form-control" id="mobile" name="mobile" placeholder=" Mobile" onkeyup="sendInfo()"  autocomplete="off">
                      <datalist id="showdatalist" > </datalist>
                  </div>
                </div>
				 <div class="form-group">
                  ...
                  <div class="col-sm-9">
                   ...
                   <input type="text"  list="showphonelist" class="form-control" id="ap" name="alternetmobile" placeholder="Phone" onkeyup="sendphoneInfo()" autocomplete="off" >
                  <datalist id="showphonelist" > </datalist>
                  </div>
                </div>		
			 <div class="form-group">
                  ...
                  <div class="col-sm-9">
                  <input type="text" list="showemaillist" class="form-control" id="email" name="email" placeholder="Email" onkeyup="sendInfo1()" autocomplete="off">
            ...
            <!-- form start -->          
              <div class="box-body">			  
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="hidden" name="pagetype" value="newleadsubmit">
                  </div>
                </div>
...
<jsp:include page="dist/include/footer.jsp" />
 <% Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Leaving newleads.jsp----------New Lead---");
...
function sendInfo()  
{  
    var id=document.newlead.mobile.id; 
var v=document.newlead.mobile.value;  
var url="mobiledatasearch.jsp?key="+v+"&id="+id;  
...
document.getElementById('showdatalist').innerHTML=val;  
}  
}  
...
function sendInfo1()  
{  
    var id=document.newlead.email.id; 
var v=document.newlead.email.value;  
var url="mobiledatasearch.jsp?key="+v+"&id="+id;  
...
document.getElementById('showemaillist').innerHTML=val;  
}  
}  
...
{  
    var id=document.newlead.alternetmobile.id; 
var v=document.newlead.alternetmobile.value;  
var url="mobiledatasearch.jsp?key="+v+"&id="+id;  
...
document.getElementById('showphonelist').innerHTML=val;  
}  
}  
