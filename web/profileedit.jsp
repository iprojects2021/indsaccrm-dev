...
<head>
  ...
  <title> Profile Edit | INDSAC CRM</title>
...
if (session != null) {
 ...
 Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+Poul.getPublicIP()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Entring profileedit.jsp------");
      ...
      if("truece".equals(pagetype)){
       ...
       String cn=Poul.escapeHtml(request.getParameter("cn"));
        ...
        String ap=Poul.escapeHtml(request.getParameter("ap"));
          String bmobile=Poul.escapeHtml(request.getParameter("bmobile"));
        String bap=Poul.escapeHtml(request.getParameter("bap"));
        String email=Poul.escapeHtml(request.getParameter("email"));
         String bemail=Poul.escapeHtml(request.getParameter("bemail"));
          String bemail1=Poul.escapeHtml(request.getParameter("bemail1"));
...
Statement st=c.createStatement();
           ResultSet rs3;
               rs3 = st.executeQuery("select  *  FROM register where id='"+cid+"'  ");
 ResultSetMetaData rsmd=rs3.getMetaData();
  ...
  st.addBatch("update register set   "+ae+"='"+cn+"',"+af+"='"+cfn+"',"+ah+"='"+department+"',"+ai+"='"+designation+"',"+ak+"='"+category+"',"+am+"='"+status+"',"+an+"='"+rt+"',"+ao+"='"+source+"',"+aq+"='"+website+"',"+as+"='"+mobile+"',"+at+"='"+ap+"',"+au+"='"+bmobile+"',"+av+"='"+bemail+"',"+aw+"='"+bemail1+"',"+ax+"='"+gstin+"',"+ay+"='"+bap+"',"+bc+"='"+address1+"',"+bd+"='"+address2+"',"+be+"='"+address3+"',"+bf+"='"+city+"',"+bg+"='"+pincode+"',"+bh+"='"+state+"',"+bi+"='"+country+"',"+bj+"='"+notes+"'   where id='"+cid+"'");
     ...
     + "LINE=174 \n  update register set where id='"+cid+"'";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg); 
        ...
        response.sendRedirect("profilesetting.jsp");
              ...
              Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+"  --------Entring prifileedit.jsp--------Redirecting To----------error.jsp-------------");
   ...
   rs.close();
      ...
      con.close();     }
               ...
               String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n profileedit.jsp-----\n"
     + "LINE=213 \n  select * from register where id="+cid+" ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg); 
                }
...
<p class="pull-right">Registered Email:<%=al.get(3) %> </p>
            ...
            <!-- form start -->
              ...
              <div class="box-body">
			    <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <input type="text" autocomplete="off" class="form-control" id="cn" name="cn" placeholder="<%=usercid_company %>" value="<%=usercid_company %>" onKeyPress="if(this.value.length==30) return false;" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text"  autocomplete="off" class="form-control" id="cfn" name="cfn" placeholder="<%=al.get(5) %>" value="<%=al.get(5) %>" autocomplete="off" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                  </div>
                <div class="col-sm-1">
				</div>
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-9">
                     <input type="text"  autocomplete="off" class="form-control" id="department" name="department" placeholder="<%=al.get(7) %>" value="<%=al.get(7) %>" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                  </div>
                </div>
				     <div class="form-group">
                  ...
                  <div class="col-sm-9">
                   <input type="text"  autocomplete="off" class="form-control" id="designation" name="designation" placeholder="<%=al.get(8) %>" value="<%=al.get(8) %>" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                  </div>
                </div>
          	     <div class="form-group">
                  ...
                  <div class="col-sm-9">
               <select name="category" id="category" class="form-control" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                   <%if(al.get(10)!=null&&!al.get(10).equals("")&&!al.get(10).equals("null")){%>
                   <option value="<%=al.get(10) %>"><%=al.get(10) %></option> <% } %>
...
<option value="Education and Children">Education and Children</option>
<option value="Entertainment and Recreation">Entertainment and Recreation</option>
<option value="Financial Services">Financial Services</option>
<option value="Health Care and Fitness">Health Care and Fitness</option>
<option value="Manufacturing">Manufacturing</option>
<option value="Non-classifiable Establishments">Non-classifiable Establishments</option>
<option value="Online and Technology">Online and Technology</option>
...
<option value="Wholesale and Distributors">Wholesale and Distributors</option>
            ...
            <!-- form start -->
              ...
              <div class="box-body">
			    <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text"  autocomplete="off" class="form-control" id="gstin" name="gstin" placeholder="<%=al.get(24) %>" value="<%=al.get(24) %>" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                  </div>
                </div>
			     <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select id="status" name="status" class="form-control" value="<%=al.get(12) %>" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                  ...
                  <div class="col-sm-10">
                    <input type="text"  autocomplete="off" class="form-control" id="rt" name="rt" placeholder="<%=al.get(13) %>" value="<%=al.get(13) %>" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                  </div>
                </div>
				  <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">  Source</label>
                    ...
                    <div class="col-sm-10">
                    <select id="source" name="source" class="form-control" value="<%=al.get(14) %>" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                          <option value="<%=al.get(14) %>"> <%=al.get(14) %></option>
			  ...
			  <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <input type="url" autocomplete="off" class="form-control" id="website" name="website" placeholder="<%=usercid_website %>" value="<%=usercid_website %>" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                  </div>
                </div>
	 ...
	 <div class="row invoice">
      ...
      <div class="box box-solid">
       <div class="box-header with-border">
          <h3 class="box-title">Personal Contact Information</h3>
        ...
        <div class="col-md-6">
          ...
          <div class="box ">
			...
			<div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Alternate Mobile</label>
	 ...
	 <div class="row invoice">
      ...
      <div class="box box-solid">
       <div class="box-header with-border">
          <h3 class="box-title">Business Contact Information</h3>
		 ...
		 <div class="box ">
            ...
            <!-- form start -->
			 ...
			 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     <input type="text" class="form-control" id="bmobile" name="bmobile" placeholder="<%=al.get(21) %>" value="<%=al.get(21) %>" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                  </div>
                </div>
		...
		<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="bap" name="bap" placeholder="<%=al.get(25) %>" value="<%=al.get(25) %>" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                  </div>
                </div>			
        ...
        <div class="col-md-6">
          ...
          <div class="box ">
            ...
            <!-- form start -->
			 ...
			 <div class="form-group">
                  <label for="inputPassword3" class="col-sm-3 control-label"> Business Email</label>

                  <div class="col-sm-9">
                  <input type="text" list="showemaillist" class="form-control" id="bemail" name="bemail" placeholder="<%=al.get(22) %>" value="<%=al.get(22) %>" onkeyup="sendInfo1()" autocomplete="off" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                  ...
                  <div class="col-sm-9">
                  <input type="text" list="showemaillist" class="form-control" id="bemail1" name="bemail1" placeholder="<%=al.get(23) %>" value="<%=al.get(23) %>" onkeyup="sendInfo1()" autocomplete="off" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                   <datalist id="showemaillist" > </datalist>
                  </div>
                </div>	 	 
		 ...
		 <div class="box ">
            ...
            <!-- form start -->
			 ...
			 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     <input type="text" class="form-control" id="address1" name="address1" placeholder="<%=al.get(29) %>" value="<%=al.get(29) %>" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                  </div>
                </div>
					 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="address2" name="address2" placeholder="<%=al.get(30) %>" value="<%=al.get(30) %>" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                  </div>
                </div>
				 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <input type="text" class="form-control" id="address3" name="address3" placeholder="<%=al.get(31) %>" value="<%=al.get(31) %>" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control" id="city" name="city"  placeholder="<%=al.get(32) %>" value="<%=al.get(32) %>" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                  </div>
                
                  <label for="inputPassword3" class="col-sm-2 control-label">Pincode</label>

                  <div class="col-sm-4">
                   <input type="text" class="form-control" id="pincode" name="pincode"  placeholder="<%=al.get(33) %>" value="<%=al.get(33) %>" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="state" name="state"  placeholder="<%=al.get(34) %>" value="<%=al.get(34) %>" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                  </div>
                </div>
				     <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="country" name="country"  placeholder="<%=al.get(35) %>" value="<%=al.get(35) %>" <% if("employee".equals(useraccountype)){  %>disabled="" <% }  %>>
                  </div>
                </div>
          ...
          <div class="box ">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                  ...
                  <div class="col-sm-10">
                      <textarea class="form-control" rows="7" id="notes" name="notes" placeholder="<%=al.get(36) %>" value="<%=al.get(36) %>"><%=al.get(36) %></textarea>
                    <input type="hidden" name="pagetype" value="truece">
                    <input type="hidden" name="cid" value="<%=al.get(0) %>">
                  </div>
                </div>
              ...
              <button class="btn btn-sm btn-info btn-flat pull-right" onClick="return myfun()" type="submit">Save</button>
            </div>
            <!-- /.box-footer -->
 ...
 <% Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+Poul.getPublicIP()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Leaving profileedit.jsp------");
...
<script>
    ...
    $('#show-alert').modal('show')
     ...
     return false;
        ...
        if(document.getElementById("cn").value.length>30){
                         document.getElementById("alert-message").innerHTML = "Business Name: Only 30 Characters allowed";
    $('#show-alert').modal('show')
    ...
    $('#show-alert').modal('show')
       document.getElementById("cfn").focus();
           ...
           if(!document.getElementById("cfn").value.match(/^[0-9 a-z.A-Z]+$/)){
              document.getElementById("alert-message").innerHTML = "Contact Name: Only alphanumeric allowed";
    $('#show-alert').modal('show')
     ...
     return false;
        ...
        if(document.getElementById("cfn").value.length>30){
                document.getElementById("alert-message").innerHTML = "Contact Name :Only 30 Characters allowed";
    $('#show-alert').modal('show')
    ...
    $('#show-alert').modal('show')
         ...
         if(document.getElementById("country").value!=""){
           ...
           if(!document.getElementById("country").value.match(/^[a-z. A-Z]+$/)){
    ...
    $('#show-alert').modal('show')
     ...
     return false;
        ...
        if(document.getElementById("country").value.length>30){
                         document.getElementById("alert-message").innerHTML = "Country: Only 30 Characters allowed";
    $('#show-alert').modal('show')
