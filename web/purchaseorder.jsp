...
<html>
    <head>
        ...
        <title>Purchase Order  | INDSAC CRM</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <% 
           ...
           if (session != null) {
            ...
            Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+"   --  Entring purchaseorder.jsp---");
     ...
     + "LINE=75 \n  select useradminid,default123 from mastertable where  useradminid="+usercid_adminid+" and default123='default' ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
                    }
        
            if(checkinvoicedefaultsetting[1]==null){
                 Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+"   -- purchaseorder.jsp--- insidecheck ---redirecting to invoicesetting.jsp");
     ...
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
               ...
               try{
                    ...
                    ResultSet rs3;
                    rs3 = st.executeQuery("select  count(id)   FROM purchaseorder where c_='1' and useradminid='"+usercid_adminid+"' ");
                    while(rs3.next()){
                        businessinvoiceno=rs3.getString(1);
                    }
                    rs3 = st.executeQuery("select  id   FROM purchaseorder ORDER BY id DESC LIMIT 1 ");
                    while(rs3.next()){
                        SR=rs3.getString(1);
                    }
                    rs3 = st.executeQuery("select c_  FROM purchaseorder where c_='0' and useradminid='"+usercid_adminid+"' ");
                    while(rs3.next()){
                    ...
                    if("null".equals(che1)){
                    String Checkinvoic="";
                    Checkinvoic=poinsert.setPOInsert(usercid_adminid, usercid_id, contact, owner);   }
                    ...
                    String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n purchaseorder.jsp-----\n"
     + "LINE=186 \n select  count(id)   FROM purchaseorder where c_='1' and useradminid='"+usercid_adminid+"' ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
               }
        ...
        <div class="wrapper">
            <%
                ...
                try{
                    ...
                    PreparedStatement smt=con.prepareStatement("select * from purchaseorder where id=?");
                    ...
                    con.close();  
                     ...
                     String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n purchaseorder.jsp-----\n"
     + "LINE=221 \n select * from purchaseorder where id="+invoiceid+" ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
                }
                int cfinal = 3;
               String Final="";
                ...
                try{
                    Connection con=Poul.getConnectionCRM();
                    PreparedStatement smt=con.prepareStatement("select cfinal,c_ from purchaseorder where id=?");
                    smt.setString(1,invoiceid);
                    ResultSet rs=smt.executeQuery();
                    while(rs.next()){
                            cfinal=(rs.getInt(1));
                    ...
                    String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n purchaseorder.jsp-----\n"
     + "LINE=247 \n select cfinal,c_ from purchaseorder where id="+invoiceid+" ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
                }
                ...
                try{
                    Connection con=Poul.getConnectionCRM();
                    PreparedStatement smt=con.prepareStatement("update purchaseorder set cfinal = ? where id = ? ");
                    smt.setInt(1,1);
                    ...
                    con.close();  
                     ...
                     String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n purchaseorder.jsp-----\n"
     + "LINE=271 \n update purchaseorder set cfinal = 1 where id ="+invoiceid+" ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
                }
                }
                ...
                try{
                    ...
                    con.close();  
                     ...
                     String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n purchaseorder.jsp-----\n"
     + "LINE=290 \n update purchaseorder set cfinal = 0 where id ="+invoiceid+" ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
                }
                }
     ...
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
                ...
                try{
                Connection con=Poul.getConnectionCRM();
                PreparedStatement smt=con.prepareStatement("select * from purchaseorderseller where poid=?");
                smt.setString(1,invoiceid);
                ResultSet rs=smt.executeQuery();
                while(rs.next()){
                    for(int i=1;i<60;i++){
                ...
                con.close();   
                    ...
                    String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n purchaseorder.jsp-----\n"
     + "LINE=333 \n select * from purchaseorderseller where poid="+invoiceid+" ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
                }
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="row" id="invoice">
                        <div class="col-sm-3">
                            <a href="invoice/purchaseorderprint.jsp?incid=<%=invoiceid %>" target="_blank"> <button type="button" class="btn btn-block btn-info"<%if(cfinal==0 || c1!=1){%>disabled<%}%>><i class="fa fa-fw fa-print"></i>Print</button></a>
                        </div>
                        <div class="col-sm-3">
                        ...
                        <form method="get" action="purchaseorder.jsp" > 
                             <%if(c1!=0){%>
                            <div class="col-sm-4">
                ...
                <form method="get" action="POAddProduct">
                <!-- Main content -->
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>   
                                            ...
                                            <a href="deletepoproduct.jsp?incid=<%=invoiceid %>&type=trsh&sn=<%=a1[jj]  %>&max=<%=iiil  %>&pro=<%=a1[jj+1]  %>&cod=<%=a1[jj+2]  %>&qt=<%=a1[jj+3]  %>&rate=<%=a1[jj+4]  %>&amt<%=a1[jj+6]  %>=#sn" > <i class="fa fa-trash-o"></i> </a>
                                        </td>               
                                    </tr>
                                    <% jj=jj+7; } %>
                                    <%
...
<%    Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Leaving purchaseorder.jsp---------- Purchaseorder--");
        %>
