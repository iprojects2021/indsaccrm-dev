...
Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+"   --  Entring purchaseorder_1.jsp---");
%>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<div class="col-sm-3">
        ...
        <br><br>
       <div class="col-sm-3">
        <a href="contact.jsp?cid=">    <button class="btn btn-block btn-info"><i class="fa fa-fw fa-check-square-o"></i>Save</button></a>
	</div>
