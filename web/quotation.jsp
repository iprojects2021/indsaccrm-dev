    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <% 
           ...
           if (session != null) {
            ...
            Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+"   --  Entring quotation.jsp---");
        %>
     ...
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
               ...
               String Final="";
                ...
                try{
                    Connection con=Poul.getConnectionCRM();
                    PreparedStatement smt=con.prepareStatement("select cfinal,c_ from quotation where id=?");
                    smt.setString(1,invoiceid);
                    ResultSet rs=smt.executeQuery();
                    while(rs.next()){
                            cfinal=(rs.getInt(1));
                    ...
                    con.close();  
                     ...
                     String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n quotation.jsp-----\n"
     + "LINE=215 \n select cfinal,c_ from quotation where id="+invoiceid+" ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
                }
                ...
                try{
                    Connection con=Poul.getConnectionCRM();
                    PreparedStatement smt=con.prepareStatement("update quotation set cfinal = ? where id = ? ");
                    smt.setInt(1,1);
                    ...
                    con.close();  
                     ...
                     String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n quotation.jsp-----\n"
     + "LINE=239 \n update quotation set cfinal =1 where id="+invoiceid+" ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
                }
                }
                ...
                try{
                    ...
                    con.close();  
                      ...
                      String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n quotation.jsp-----\n"
     + "LINE=258 \n update quotation set cfinal =0 where id="+invoiceid+" ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
                }
                }
     ...
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
                ...
                try{
                Connection con=Poul.getConnectionCRM();
                PreparedStatement smt=con.prepareStatement("select * from quotationseller where quotationid=?");
                smt.setString(1,invoiceid);
                ResultSet rs=smt.executeQuery();
                while(rs.next()){
                    for(int i=1;i<60;i++){
                ...
                con.close();   
                    ...
                    String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n quotation.jsp-----\n"
     + "LINE=301 \n select * from quotationseller where quotationid="+invoiceid+" ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
                }
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="row" id="invoice">
                        <div class="col-sm-3">
                            <a href="invoice/quotationprint.jsp?incid=<%=invoiceid %>" target="_blank"> <button type="button" class="btn btn-block btn-info"<%if(cfinal==0 || c1!=1){%>disabled<%}%>><i class="fa fa-fw fa-print"></i>Print</button></a>
                        </div>
                        <div class="col-sm-3">
                        ...
                        <form method="get" action="quotation.jsp" > 
                             <%if(c1!=0){%>
                            <div class="col-sm-4">
...
<%    Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Leaving quotation.jsp------");
        %>
