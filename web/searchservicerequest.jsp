...
<head>
  ...
  <title>Search Service Request | INDSAC CRM</title>
...
<body class="hold-transition skin-blue sidebar-mini">
	...
	Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Entering searchservicerequest.jsp----------Search Service Request---");
...
if (session != null) {
 ...
 Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+"   -------Entring searchservicerequest.jsp---");
%>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    duedate=duedate+" 23:59:59";
       ...
       try{ Connection con=Poul.getConnectionCRM();
        PreparedStatement smt=con.prepareStatement("select * from servicerequest where useradminid='"+usercid_adminid+"' AND   duedate='"+duedate+"' ; ");
      ...
      con.close(); 
          ...
          String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n searchservicerequest.jsp---"
           + "\nLINE=102 \n-- select * from servicerequest where useradminid="+usercid_adminid+" AND   duedate='"+duedate+"'";
 ...
 <div class="box-header with-border">
          <h3 class="box-title"> Service Request Search Result</h3>
          <form action="">        <button type="submit" class="btn btn-info pull-right"  > Search More SR</button></form>
              ...
              <div class="table-responsive">
                <table  id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                     ...
                     <td ><a href="servicerequestedit.jsp?2a2e2a746964=<%=Nd.Encrypt(taskdata1[m][1]) %>"><% out.print("SR"+taskdata1[m][1]); %></a></td>
        ...
        <!-- ./col -->
		 ...
		 <% } %>
          ...
          <% 
           ...
           String count1;  count1="1";
       try{ Connection con=Poul.getConnectionCRM();
        PreparedStatement smt=con.prepareStatement("select COUNT(*) from servicerequest where useradminid='"+usercid_adminid+"' AND   priority='"+priority+"'; ");
      ...
      con.close();         
        ...
        String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n searchservicerequest.jsp---"
           + "\nLINE=235 \n-- select  COUNT(*) from servicerequest where useradminid="+usercid_adminid+" AND  priority='"+priority+"';";
         Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
      }
       ...
       String taskdata1[][]=new String[n1+1][55];
        try{ Connection con=Poul.getConnectionCRM();
        PreparedStatement smt=con.prepareStatement("select * from servicerequest where useradminid='"+usercid_adminid+"'  and  priority='"+priority+"'; ");
    ...
    rs.close();
      ...
      con.close();    } catch(Exception e){ 
         String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n searchservicerequest.jsp---"
           + "\nLINE=261 \n-- select  * from servicerequest where useradminid="+usercid_adminid+" AND  priority='"+priority+"';";
         Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
       EmergencyEmail.send(e,errormsg);
      }
 ...
 <div class="box-header with-border">
          <h3 class="box-title"> SR Search Result</h3>
          <form action="">        <button type="submit" class="btn btn-info pull-right"  > Search More SR</button></form>
        ...
        <!-- ./col -->
		 ...
		 <% } %>
           ...
           String count1;  count1="1";
       try{ Connection con=Poul.getConnectionCRM();
        PreparedStatement smt=con.prepareStatement("select COUNT(*) from servicerequest where useradminid='"+usercid_adminid+"'  and  status='"+status+"'; ");
     ...
     rs.close();
      ...
      con.close();        
           ...
           String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n searchservicerequest.jsp---"
           + "\nLINE=368 \n-- select COUNT(*) from servicerequest where useradminid="+usercid_adminid+" AND  status='"+status+"'";
         Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
       EmergencyEmail.send(e,errormsg);
      }
       ...
       String taskdata1[][]=new String[n1+1][55];
        try{ Connection con=Poul.getConnectionCRM();
        PreparedStatement smt=con.prepareStatement("select * from servicerequest where useradminid='"+usercid_adminid+"'  and  status='"+status+"'; ");
    ...
    rs.close();
      ...
      con.close();    } catch(Exception e){
         String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n searchservicerequest.jsp---"
           + "\nLINE=394 \n-- select * from servicerequest where useradminid="+usercid_adminid+" AND  status='"+status+"'";
         Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
       EmergencyEmail.send(e,errormsg);
      }
 ...
 <div class="box-header with-border">
        ...
        <!-- ./col -->
		 ...
		 <% } %>
           ...
           String count1;  count1="1";
       try{ Connection con=Poul.getConnectionCRM();
        PreparedStatement smt=con.prepareStatement("select count(t.id) from servicerequest t,contact c where t.customerid=c.id and t.useradminid='"+usercid_adminid+"'  and  c.customertype='"+customertype+"'; ");
      ...
      con.close();        Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+",Searchby="+tksrch+" ,count="+count1+" -- searchtask.jsp----------Search Task---");
            ...
            String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n servicerequest.jsp---"
           + "\nLINE=500 \n-- select count(t.id) from servicerequest t,contact c where t.customerid=c.id and t.useradminid="+usercid_adminid+" AND  c.customertype="+customertype+"";
         Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
      }
       ...
       String taskdata1[][]=new String[n1+1][55];
        try{ Connection con=Poul.getConnectionCRM();
        PreparedStatement smt=con.prepareStatement("select t.id,t.timestamp,t.subject,t.status,t.duedate,t.priority,t.assign,c.customertype from servicerequest t,contact c where t.customerid=c.id and t.useradminid='"+usercid_adminid+"'  and  c.customertype='"+customertype+"'; ");
     ...
     rs1.close();
      ...
      con.close();   } catch(Exception e){
               String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n servicerequest.jsp---"
           + "\nLINE=526 \n-- select t.id,t.timestamp,t.subject,t.status,t.duedate,t.priority,t.assign,c.customertype from servicerequest t,contact c where t.customerid=c.id and t.useradminid="+usercid_adminid+" and  c.customertype='"+customertype+"";
         Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
      }
 ...
 <div class="box-header with-border">
    ...
    taskdate=taskdate+" 00:00:00";todate=todate+" 23:59:59";
           ...
           String count1;  count1="1";
       try{ Connection con=Poul.getConnectionCRM();
        PreparedStatement smt=con.prepareStatement("select * from servicerequest where useradminid='"+usercid_adminid+"' AND  timestamp between '"+taskdate+"' and '"+todate+"'; ");
    ...
    rs.close();
      ...
      con.close();          Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+",Searchby="+tksrch+" ,count="+count1+" -- searchtask.jsp----------Search Task---");
          ...
          String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n servicerequest.jsp---"
           + "\nLINE=644 \n-- select * from servicerequest where useradminid='"+usercid_adminid+"' AND  timestamp between '"+taskdate+"' and '"+todate+"";
         Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
     EmergencyEmail.send(e,errormsg);
      }
     ...
     <div class="row">
      ...
      <div class="box box-default ">
       <!-- /.box-header -->
        <div class="box-body">
              <div class="box-header with-border">
          <h3 class="box-title"> SR By Created Date</h3>
        </div>
...
<div class="col-sm-12">
      ...
      <div class="box box-default ">
       <!-- /.box-header -->
        <div class="box-body">
              <div class="box-header with-border">
          <h3 class="box-title"> SR By Due Date</h3>
        </div>
...
<jsp:include page="dist/include/footer.jsp" />
  <%  Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Leaving searchservicerequest.jsp----------Search Service Request---");
      %>
  <!-- /.control-sidebar -->
