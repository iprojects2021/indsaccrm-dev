...
Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+"   --  Entring ushaaiinvoice.jsp---");
...
Statement st=c.createStatement();
 ...
 ResultSet rs3;
               rs3 = st.executeQuery("select  *  FROM ushaaiinvoice  ");
    while(rs3.next())
    ...
    cdata[6]=cdata[6].concat(cdata[7]);
           ...
           if("null".equals(che1)){
   st.addBatch("insert into ushaaiinvoice values('"+i+"',"
                      + "'"+sqlTime+"',"
                      + "'0'," + "'"+owner+"'," + "''," + "'',"   + "'',"  + "'',"+ "'',"+ "'',"
...
Statement st=con.createStatement();
  ...
  st.addBatch("update ushaaiinvoice set   "+ac+"='1',"+ae+"='"+invoicedate+"',"+af+"='"+reversecharge+"',"+ag+"='"+state1+"',"+ah+"='"+statecode1+"',"+ai+"='"+transporter+"',"+aj+"='"+vehicleno+"',"+ak+"='"+supplydate+"',"+all+"='"+supplyplace+"',"+am+"='"+bname+"',"+an+"='"+baddress1+"',"+ao+"='"+baddress2+"',"+app+"='"+baddress3+"',"+aq+"='"+bcontact1+"',"+ar+"='"+bcontact2+"',"+at+"='"+bdistt+"',"+au+"='"+bstate+"',"+aw+"='"+bgstin+"',"+ay+"='"+sname+"',"+az+"='"+saddress1+"',"+ba+"='"+saddress2+"',"
       ...
       invoiceid=incid;
        ...
        {
            String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n ushaaiinvoice.jsp-----\n"
     + "LINE=828 \n update ushaaiinvoice set  where id='"+incid+"'  ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
        }
...
%>
      ...
      <!-- info row -->
      <form method="get" action="ushaaiinvoice.jsp">
...
<option value="West Bengal & Code=19">West Bengal</option>
 ...
 <label for="inputEmail3" class="col-sm-1 control-label"> <%if("".equals(a1[j])||"null".equals(a1[j]) ){ %>- <% }else {%> <%=a1[j]  %> <% }%></label>
                  ...
                  <div class="col-sm-1">
                      <a href="ushaaiinvoice.jsp?incid=<%=invoiceid %>&type=proinedit&sn=<%=a1[j]  %>" >  <i class="fa fa-edit"></i></a>
                      <a href="test1.jsp?incid=<%=invoiceid %>&type=trsh&sn=<%=a1[j]  %>&max=<%=iiil  %>#sn" > <i class="fa fa-trash-o"></i> </a>
                  </div>
                                                                   </div>
           ...
           String count2="0";
       try{ Connection con=Poul.getConnectionCRM();
        PreparedStatement smt=con.prepareStatement("select count(*) from stock ");
     ...
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
       ...
       String taskdata2[][]=new String[n2+1][55];
        try{ Connection con=Poul.getConnectionCRM();
        PreparedStatement smt=con.prepareStatement("select * from stock ");
...
<option  value="Jar1" >Jar1</option>
<option  value="jar2" >Jar2</option>
...
<option  value="Ton">Ton</option>
      ...
      <input type="hidden" name="down" value="true">
        ...
        <div class="col-xs-12">
            <a href="invoice/ushaaiinvoiceprint.jsp?incid=<%=invoiceid %>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
        
        </div>
      </div>
      </form> <div class="col-xs-12">
         <a href="contactdetails.jsp?cid=<%=a1[59] %>&type=contact"><button  class="btn btn-info pull-right"> View Contact </button></a>
         ...
         <div class="col-sm-6 invoice-col">
              ...
              <div class="col-sm-4">
                  ...
                  <div class="col-sm-8">
                       <input type="text" class="form-control" id="bname" name="depositorname" <%if("".equals(a1[13])||"null".equals(a1[13]) ){ %>placeholder=" Name" <% }else {%> placeholder="<%=a1[13] %>" value="<%=a1[13]  %>" <% }%>>
           ...
           <div class="form-group">
              <div class="col-sm-4">
                  ...
                  <div class="col-sm-8">
                      <input type="text" class="form-control" id="bname" pattern="[0-9]{0-100}" name="amtreceived" placeholder="Amount " autocomplete="off" > 
...
<option  value="Other">Other</option>
          ...
          <br><br>
              ...
              <div class="col-sm-4">
                  ...
                  <div class="col-sm-8">
                      <input type="text" class="form-control" id="baddress2" name="payref" placeholder="Reference No" autocomplete="off">
          ...
          <div class="box-footer clearfix">
             ...
             <button class="btn btn-sm btn-info btn-flat pull-right"  type="submit">Submit</button>
            </div>
       ...
       try{
        ...
        Connection con=Poul.getConnectionCRM();
        PreparedStatement smt=con.prepareStatement("select count(*) from paymentinfo where f_=?");
        smt.setString(1,invoiceid);
        ResultSet rs=smt.executeQuery();
        ...
        while(rs.next()){
            count123=rs.getString(1);
                ...
                String errormsg=java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"\n ushaaiinvoice.jsp-----\n"
     + "LINE=1980 \n select count(*) from paymentinfo where f_="+invoiceid+" ";
     Log.writeLogWarn(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+"  /n"+errormsg+" /n"+e);
      EmergencyEmail.send(e,errormsg);
                }
       ...
       try{
        ...
        Connection con=Poul.getConnectionCRM();
        PreparedStatement smt=con.prepareStatement("select * from paymentinfo where f_=?");
        smt.setString(1,invoiceid);
        ResultSet rs=smt.executeQuery();
...
<% Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+Poul.getPublicIP()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Leaving ushaaiinvoice.jsp------");
