...
<head>
  ...
  <title> Vendor Edit | INDSAC CRM</title>
...
Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+"   --  Entring vendoredit.jsp---");
...
Statement st=c.createStatement();
           ResultSet rs3;
               rs3 = st.executeQuery("select  *  FROM contact where id='"+vid+"'  ");
 ResultSetMetaData rsmd=rs3.getMetaData();
  ...
  st.addBatch("update contact set   "+ae+"='"+cn+"',"+af+"='"+cfn+"',"+ag+"='"+cln+"',"+ah+"='"+department+"',"+ai+"='"+designation+"',"+aj+"='"+dob+"',"+ak+"='"+category+"',"+all+"='"+sc+"',"+am+"='"+status+"',"+an+"='"+rt+"',"+ao+"='"+source+"',"+app+"='"+vn+"',"+aq+"='"+website+"',"+ar+"='"+bwtc+"',"+as+"='"+mobile+"',"+at+"='"+ap+"',"+au+"='"+phone+"',"+av+"='"+email+"',"+aw+"='"+oe+"',"+ax+"='"+fax+"',"+ay+"='"+oai+"',"+az+"='"+oai1+"',"+ba+"='"+oai2+"',"+bb+"='"+oai3+"',"+bc+"='"+address1+"',"+bd+"='"+address2+"',"+be+"='"+address3+"',"+bf+"='"+city+"',"+bg+"='"+pincode+"',"+bh+"='"+state+"',"+bi+"='"+country+"',"+bj+"='"+notes+"',"+bk+"='"+gstin+"'   where id='"+vid+"'");
     ...
     + "LINE=168 \n select  *  FROM contact where id='"+vid+"' ";
...
Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+request.getRemoteAddr()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+"   --  Entring vendoredit.jsp---------Redirecting To-------------error.jsp-----------");
...
<form class="form-horizontal" action="" method="get">
	 ...
	 <div class="row invoice">
      ...
      <div class="box box-warning box-solid">
        <div class="box-header with-border">
          ...
          <p class="pull-right">Created By:<%=Db.getEmployeeName(al.get(39)) %> </p>
		 ...
		 <div class="form-group">
                  ...
                  <label for="inputEmail3" class="col-sm-3 control-label">  Source</label>
                    ...
                    <select id="source" name="source" class="form-control" value="<%=al.get(14) %>">
                          <option value="<%=al.get(14) %>"> <%=menu.Marketing.getEventName(al.get(14)) %></option>
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="hidden" name="2a2e2a766964" value="<%=Nd.Encrypt(al.get(0)) %>">
                  </div>
                </div>
 ...
 <% Log.writeLog(java.time.LocalDate.now()+" "+java.time.LocalTime.now()+" ,"+Poul.getPublicIP()+" ,useradminid="+usercid_adminid+" ,usercid="+usercid_id+" --Leaving vendoredit.jsp------");
